...
† Uses board manager: http://arduino.esp8266.com/stable/package_esp8266com_index.json ([*source*](https://github.com/esp8266/Arduino#installing-with-boards-manager)).
